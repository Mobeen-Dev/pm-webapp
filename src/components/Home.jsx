              ...
              <div className="w-full text-center">
                ...
                <div className="mb-12">
                  ...
                  <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
                    Discover cutting-edge development services and innovative solutions
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Professional development services with cutting-edge technology
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <p className="text-gray-600">Optimized performance with modern technologies for exceptional user experience.</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Reliable</h3>
                <p className="text-gray-600">Trusted by thousands of developers worldwide with 99.9% uptime guarantee.</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-4">User Friendly</h3>
                <p className="text-gray-600">Intuitive interface designed with user experience as our top priority.</p>
              </div>
            </div>
          </div>
        </div>
